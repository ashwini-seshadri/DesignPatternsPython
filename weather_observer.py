...
class CurrentConditionsDisplay(Observer, DisplayElement):
    ...
    def display(self):
        print(f"Current conditions: {self.temperature}F degreed and {self.humidity}% humidity")

class StatisticsDisplay(obeserver, DisplayElement):
    def __init__(self, weather_data):
        self.weather_data = weather_data
        self.weather_data.register_observer(self)
        self.max_temp = 0
    ...
    def display(self):
        print(f"Avg/Max/Mintemperature = {(self.temp_sum / self.num_readings)}/{self.max_temp}/{self.min_temp}")
...
class ForecastDisplay(Observer, DisplayElement):
    ...
    def display(self):
        ...
        if self.current_pressure > self.last_pressure:
            print("Better weather soon!")
        elif self.current_pressure == self.last_pressure:
            print("Same!")
        elif self.current_pressure < self.last_pressure:
            print("Cold or rainy weather")
